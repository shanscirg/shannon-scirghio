...
export default function ProjectCard({ imageSrc, siteName, liveSite, description, githubSite, siteLogo }) {
    return (
        <Col className='project-card' style={{border: "1px solid black", padding: "20px", margin: "30px", "box-shadow": "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)", background: "rgba(0, 0, 0, 0.3)"}} xs={12} lg={5}>
            <div className='image'>
